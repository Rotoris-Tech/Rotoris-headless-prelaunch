...
export const metadata = {
  title: "Astonia - Rotoris",
  description: "Discover Astonia by Rotoris",
};

export default function Astonia() {
  return (
      ...
      <main className="mx-auto max-w-7xl px-6 py-16 sm:px-8 lg:px-12">
        ...
        <div className="mt-12">
          ...
          <p className="mt-6 text-lg leading-8 text-zinc-600 dark:text-zinc-400">
            Welcome to Astonia - a premium product by Rotoris.
          </p>
          ...
          <div className="mt-12 space-y-8">
            <section>
              ...
              <p className="mt-4 text-base leading-7 text-zinc-600 dark:text-zinc-400">
                Add your product description here. Highlight the key features and benefits of Astonia.
              </p>
            </section>
